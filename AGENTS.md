...
- Product truth comes from canonical mobile-app docs, not marketing guesses. Current product: two nearby people, simultaneous voice through Bluetooth HFP microphone/playback, no intentional handset fallback. Android is on Google Play; iPhone built and submitted to Apple; Clay confirms full cross-platform capability. Public listing URL is still needed for the App Store CTA. Do not infer public availability solely from an upload or search results. Do not promise E2E encryption, universal compatibility, group/mesh, Internet calling or safety-critical use.
