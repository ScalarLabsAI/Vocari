...
## Images
All ten product photo slots await permission. Cards intentionally link to real manufacturer galleries instead of showing invented products or unlicensed images. To activate: obtain owner photo or approved program creative, record provenance/rights in docs/ASSETS.md, populate image src/alt/width/height and imagePermission approved + grant. Follow contract restrictions on caching, hosting, modification, region, expiry and linking. Amazon content requires its approved mechanism and refresh rules; do not copy static Amazon photos into this repository.
